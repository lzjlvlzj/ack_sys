/**
 * 分页工具
 * https://github.com/lzjlvlzj/pagination
 * 
 * 
 * */
...
(function($){
    ...
    //绑定事件
    $.fn.paginator.event = function(callback, currentPage, totalPage, pageNumSize){

        //首页事件
        startPageEvent(callback, totalPage, pageNumSize);
        //末页事件
        endPageEvent(callback, totalPage, pageNumSize);
        //上一页事件
        prevPageEvent(callback,totalPage, pageNumSize);
        //下一页事件
        nextPageEvent(callback,totalPage, pageNumSize);
        //普通页码事件
        numberPageEvent(callback, totalPage);
    };
    ...
    var startPageEvent = function(callback, totalPage,pageNumSize){
    ...
    var endPageEvent = function(callback,totalPage,pageNumSize){
        ...
        endPage.unbind().click(function(){
            ...
            $.fn.paginator.flush(totalPage , totalPage,pageNumSize);
            callback(totalPage);
        });

    };
    var prevPageEvent = function(callback,totalPage ,pageNumSize){
    ...
    var nextPageEvent = function(callback, totalPage, pageNumSize){
        var pageLast = $("#page_last");
    ...
    var numberPageEvent = function(callback,totalPage){
