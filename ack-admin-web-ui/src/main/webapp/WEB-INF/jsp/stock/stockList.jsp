...
<body>
	...
	<div class="row">
		...
		<div class='col-xs-12'>
			<button class="btn btn-primary" id="ack-add-btn" data-toggle="modal"
				onclick="Stock.eidtUI();">新建仓储</button>
		</div>
	</div>
	...
	<script type="text/javascript" src="/static/js/stock/stock.js"></script>
	<script type="text/javascript">
