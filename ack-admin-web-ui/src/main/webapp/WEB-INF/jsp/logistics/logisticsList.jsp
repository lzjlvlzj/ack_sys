...
<body>
	...
	<div class="row">
		<div class="col-xs-12">
			<h3 class="header smaller lighter blue">物流管理</h3>
				...
				<thead>
					<tr role="row">
						...
						<th class="hidden-480 sorting" tabindex="0"
							aria-controls="dynamic-table" rowspan="1" colspan="1">物流车辆</th>
						<th class="hidden-480 sorting" tabindex="0"
							aria-controls="dynamic-table" rowspan="1" colspan="1">司机师傅</th>
						<th class="hidden-480 sorting" tabindex="0"
							aria-controls="dynamic-table" rowspan="1" colspan="1">司机电话</th>
		...
		<div class='col-xs-12'>
			<button class="btn btn-primary" id="ack-add-btn" data-toggle="modal"
				onclick="Logistics.eidtUI();">新建物流</button>
		</div>
	</div>
	...
	<script type="text/javascript" src="/static/js/logistics/logistics.js"></script>
	<script type="text/javascript">
