				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" id="menuName" placeholder="菜单名称"
							name="menuName" value="" class="form-control col-xs-10 col-sm-8">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-right"
					...
					<div class="col-sm-9">
						<input type="text" id="url" placeholder="url" name="url"
							value="" class="form-control col-xs-10 col-sm-8">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" id="menulevel" placeholder="菜单等级"
							name="menuLevel" value="" class="form-control col-xs-10 col-sm-8">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-right"
					...
					<div class="col-sm-9">
						<input type="text" id="permission" placeholder="权限字符"
							name="permission" value="" class="form-control col-xs-10 col-sm-8">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-right"
					...
					<div class="col-sm-9">
						<input type="text" id="domId" placeholder="页面dom的id(只是左侧菜单用)"
							name="domId" value="" class="form-control col-xs-10 col-sm-8">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-right"
					...
					<div class="col-sm-9">
						<input type="text" id="css" placeholder="菜单样式(只是左侧菜单用)"
							name="css" value="" class="form-control col-xs-10 col-sm-8">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-right"
