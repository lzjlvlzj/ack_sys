			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container">
						<div class="center">
							<h1>
								<i class="ace-icon fa fa-leaf green"></i> <span class="red">ACK</span>
								<span class="white" id="id-text2">System</span>
							</h1>
							<h4 class="blue" id="id-company-text">&copy; www.itblg.com</h4>
						</div>
							...
							<div id="login-box"
								...
								<div class="widget-body">
									<div class="widget-main">
										...
										<form id="ack-login-form" method="post">
											<fieldset>
												...
												<div class="clearfix">
													...
													<button type="button" id="ack-login-btn"
									...
									<div class="widget-main">
										...
										<form>
											<fieldset>
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="email" class="form-control" placeholder="loginName" />
														<i class="ace-icon fa fa-envelope"></i>
												</span>
												</label> <label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
...
<!--[if !IE]> -->
<script src="/static/3part/ace/js/jquery-2.1.4.min.js"></script>
<!-- <![endif]-->
<!--[if IE]>
<script src="${pageContext.request.contextPath}/static/3part/ace/js/jquery-1.11.3.min.js"></script>
<![endif]-->
