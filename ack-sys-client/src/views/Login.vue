  ...
  <div>
    ...
    <span class="tool-bar">
      ...
      <el-form-item style="width:100%;">
        ...
        <el-button type="primary" style="width:48%;" @click="login('loginForm')" :loading="loading">登 录</el-button>
      </el-form-item>
      <el-form-item>
        <el-col :span="12"><el-link type="primary" :underline="false">忘记密码</el-link></el-col>
        <el-col :span="12"><el-link type="primary" :underline="false">快捷登录</el-link></el-col>
      </el-form-item>
    </el-form>
        ...
        if (valid) {
          ...
          this.$api.login.login(userInfo).then((res) => {
            ...
            if(res.code != 200) {
              ...
              this.$store.commit('setUserInfo', res.data)//保存用户
