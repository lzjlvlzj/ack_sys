<template>
  <div class="personal-panel">
    <div class="personal-desc" :style="{'background':this.$store.state.app.themeColor}">
        ...
        <div class="name-role">
          <span class="sender">{{ user.name }} - {{ user.realName }}</span>
        </div>
        <!--
    ...
    <div class="main-operation">
        <span class="main-operation-item">
          <el-button size="small" icon="fa fa-male" @click="personalCenter"> 个人中心</el-button>
        </span>
        <span class="main-operation-item">
          <el-button size="small" icon="fa fa-key" @click="personalPwd"> 修改密码</el-button>
        </span>
    </div>
    <!--
...
export default {
  ...
  methods: {
    ...
    personalPwd:function(){
      this.$router.push("/personal/pwd")
    },
    // 退出登录
    logout: function() {
