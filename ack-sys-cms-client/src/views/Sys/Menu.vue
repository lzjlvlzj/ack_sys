  ...
  <div class="page-container">
	...
	<div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
		<el-form :inline="true" :model="filters" :size="size">
			...
			<el-form-item>
				<kt-button icon="fa fa-search" :label="$t('action.search')" perms="sys:menu:view" type="primary" @click="findPage(null)"/>
			</el-form-item>
			<el-form-item>
    ...
    <div class="toolbar" style="padding:10px;">
      <el-pagination layout="total, prev, pager, next, jumper" @current-change="refreshPageRequest"
                     :current-page="pageRequest.currentPage" :page-size="data.pageSize" :total="data.totalRecord" style="float:right;">
      </el-pagination>
    </div>
    <!-- 新增修改界面 -->
    <el-dialog :title="!dataForm.id ? '新增' : '修改'" width="40%" :visible.sync="dialogVisible" :close-on-click-modal="false">
      <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="submitForm()"
        ...
        <el-form-item label="上级菜单" prop="parentName">
          <el-input v-model="dataForm.parentId" placeholder="父菜单id"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    findPage: function() {
      ...
      this.$api.menu.findPage(this.pageRequest).then(res => {
        this.data = res.data
